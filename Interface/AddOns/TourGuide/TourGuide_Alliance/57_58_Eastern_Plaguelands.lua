...
return [[
R Eastern Plaguelands |QID|5601| |N|Don't mis the flight point on the river!|
A Demon Dogs |N|Follow the river north (4.64, 38.49)| |QID|5542|
A Blood Tinged Skies |QID|5543|
A Carrion Grubbage |QID|5544|

N Kill crap... |N|Kill any plaguehounds, carrion worms, and plaguebats you encounter in EPL for each respective quest.| |QID|5544|
C The Eastern Plagues |N|Around the Marris Stead, just north of the road.  Rutger (25.17, 73.09), Fredo (23.60, 68.46), Turyen (25.12, 68.37)| |QID|6185|

T Sister Pamela |N|In a house in Darrowshire (32.48, 83.65)| |QID|5601|
...
A Zaeldarr the Outcast |N|Southwest near the corpse pits (73.92, 57.70)| |QID|6021|

N Free Spirits... |QID|5211| |N|Kill any cannibal ghouls, gibbering ghouls and diseased flayers you come across.  Speak to any ghosts that spawn for "Defenders of Darrowshire".|
