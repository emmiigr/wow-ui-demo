...
TourGuide:RegisterGuide("Borean Tundra (70-72)", "Dragonblight (72-73)", "Horde", function()
return [[
A Hellscream's Vigil |QID|11585| |T|
T Hellscream's Vigil |QID|11585| |T|
A The Defense of Warsong Hold |QID|11596| |T|
T The Defense of Warsong Hold |QID|11596| |T|
...
C Patience is a Virtue that We Don't Need |QID|11606|
...
C Cutting Off the Source |QID|11602|
...
A Too Close For Comfort |QID|11574| |T|
A Ride to Taunka'le Village |QID|11888| |T|
T Message to Hellscream |QID|11616| |T|
A Reinforcements Incoming... |QID|11618| |T|
A To Bor'gorok Outpost, Quickly! |QID|12486| |T|
T Wind Master To'bor |QID|11634| |N|Go up the elevator| |T|
A Magic Carpet Ride |QID|11636| |T|

T Magic Carpet Ride |QID|11636| |N|Talk to Yanni for a ride to Garrosh's Landing.|
...
C Mobu's Pneumatic Tank Transjigamarig |QID|11643|
A Escaping the Mist |QID|11664| |N|In the building near the other quest givers (31.86, 52.44)|
C Super Strong Metal Plates! |QID|11644|
C Horn of the Ancient Mariner |QID|11660| |N|Keep killing Kvaldir Mistweaver's until it drops.|
C Into the Mist |QID|11655| |N|Keep killing Kvaldir until it drops.|
...
C Burn in Effigy |QID|11656| |U|34830| |N|Out on the coast, burn down Bor's Hammer (29.74, 52.85), The Kur Drakkar (30.90, 48.97)m The Serpent's Maw (31.48, 48.32), and Bor's Anvil (30.06, 61.60)|

C Orabus the Helmsman |QID|11661| |N|At the end off Warsong Jetty (26.58, 54.60)| |U|34844|

T Burn in Effigy |QID|11656| |N|At a small camp on the Coast of Echoes (32.29, 54.24)|
...
T The Abandoned Reach |QID|11870| |N|Down the hill from Karen (57.74, 55.08)|
A Not On Our Watch |QID|11871|
C Not On Our Watch |QID|11871| |N|To the southeast|
T Not On Our Watch |QID|11871| |N|Back at Hierophant Liandra (57.76, 55.08)|
A The Nefarious Clam Master... |QID|11872|
C The Nefarious Clam Master... |QID|11872| |N|Kill Clam Master K to the southwest at the shipwreck (61.61, 66.40)|
...
C Monitoring the Rift: Cleftcliff Anomaly |QID|11576| |N|Southwest, past Beryl Point, take a little swim to the Westrift (34.36, 42.13).  Use the [Arcanometer]| |U|34669|
C Prison Break |QID|11587| |N|At Beryl Point (42.74, 36.95)|

T Prison Break |QID|11587| |N|Back up on Amber Ledge (45.19, 33.36)|
...
C Abduction |QID|11590| |N|Go find a Beryl Sorcerer, beat him a bit, then use the [Arcane Binder] on him.| |U|34691|
T Abduction |QID|11590| |N|Back up on Amber Ledge (45.21, 33.38)|
A The Borean Inquisition |QID|11646|
T The Borean Inquisition |QID|11646| |N|Up in the tower (46.36, 32.83)|
A The Art of Persuasion |QID|11648|
C The Art of Persuasion |QID|11648| |N|Stabby stabby!| |U|34811|
...
C A Race Against Time |QID|11671| |N|Head down to the large round platform (41.79, 39.22), use the [Beryl Shield Detonator], kill Inquisitor Salrand.| |U|34897|
T A Race Against Time |QID|11671| |N|Back up on Amber Ledge (45.21, 33.44)|
A Reforging the Key |QID|11679|
T Reforging the Key |QID|11679|
A Taking Wing |QID|11680|
T Taking Wing |QID|11680|
A Rescuing Evanor |QID|11681|
...
T Farseer Grimwalker's Spirit |N|At the very bottom of the cave (56.16, 9.20) you will find Farseer Grimwalker's Spirit.  Kill the 3 Magmoth Shamans around him to release him so you can speak with him.| |QID|11635|
...
A Not Without a Fight! |QID|11949| |N|East at Kaskala (63.81, 46.10)|
...
C Master the Storm |QID|11895| |T| |N|Now go behind Sage Earth and Wind into the building here, click the storm totem.   This will summon the air elemental you need to kill.|
...
C The Heart of the Elements |QID|11685|
...
T Sage Highmesa is Missing |QID|11674| |N|North of the village to (74.61, 23.72)|
...
T Find Bristlehorn |N|Go inside Talramas and up the ramp to the right.  Bristlehorn is on the top floor.| |QID|11678|
...
T Shatter the Orbs! |QID|11659| |T| |O|
