...
C A New Ore Sample |QID|1153| |N|Kill kobolds around the east end of the needles.  Skip this if you can't get the drop, the mobs are sparse.| |NORAF|
...
T A New Ore Sample |QID|1153| |N|Back at Camp Taurajo (45.11, 57.75).  Hearth if you can.| |Z|The Barrens| |NORAF|
T Enraged Thunder Lizards |QID|907| |O| |NORAF|
A Cry of the Thunderhawk |QID|913| |O| |PRE|Enraged Thunder Lizards| |NORAF|
C Cry of the Thunderhawk |QID|913| |O| |PRE|Enraged Thunder Lizards| |NORAF|
T Cry of the Thunderhawk |QID|913| |O| |PRE|Enraged Thunder Lizards| |NORAF| |N|Skip the follow-up|
